  ...
  return (
    <section className="p-6">
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-gray-100 text-gray-700">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-medium">Sigle</th>
              <th className="px-4 py-3 text-left font-medium">Adresse</th>
              <th className="px-4 py-3 text-left font-medium">IFU</th>
          ...
          <tbody>
            {clients.map((client, index) => (
              ...
              >
                ...
                <td className="px-4 py-3">{client.sigle}</td>
                <td className="px-4 py-3">{client.address}</td>
                <td className="px-4 py-3">{client.ifu}</td>
      ...
      {openRow && (
        ...
        >
          <li>
            <Link href={`/client/${openRow}/modifier`}>
